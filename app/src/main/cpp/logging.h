...
// __android_log_is_loggable() requires API 30+; this project's minSdk is 26, so the log-level
// threshold is just compared directly instead (no per-tag runtime property override, not needed here).
